<template>
  ...
  <div class="row">
    <div>
      ...
      <h1>This is the town component</h1>
      </div>
  ...
  if (selectedNpc.value.name === 'blacksmith') {
    router.push({ name: 'blacksmith' });
  } else if (selectedNpc.value.name === 'banker') {
  ...
  <style>
  .blacksmith { top: 300px; left: 400px; }
  .banker { top: 300px; left: 1000px; }
  </style>
