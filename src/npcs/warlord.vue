    ...
    <div class="row side-menu-all">
      <div class="col-md-8 mt-5">
          ...
          <div class="col-md-10 d-flex flex-column justify-content-center align-items-center">
            <div>
              <img class="npc-talk-img" src="../../images/warlord.PNG">
            </div>
            <div class="row d-flex ">
              ...
              <div class="row">
                <div class="">
                  <p class="headline-npc" id="headlineID">What can I use you for?
                  </p>
                  <div>
                    <p class="npc-text" id="npctalk">What value do you carry for this great country?</p>
                  </div>
...
const help1_valasz = async () => {
  ...
  NPCCheck(NPCID)
    ...
    szoveg.innerText = 'With this god\'s help I can have a legacy that won\'t be forgotten!';

    szovegCIM.innerText = 'That is a clever strategy, but I give it a shot!';
    szoveg.innerText = 'I won\'t forget your and your god\'s help with our battles!';
...
const help2_valasz = async () => {
  ...
  NPCCheck(NPCID)
    ...
    szoveg.innerText = 'I will pray before every battle, if I win the next!';
