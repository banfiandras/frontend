    ...
    <div class="row side-menu-all">
      <div class="col-md-8 mt-5">
          ...
          <div class="col-md-10 d-flex flex-column justify-content-center align-items-center">
            <div>
              <img class="npc-talk-img" src="../../images/blacksmith.PNG">
            </div>
            <div class="row d-flex ">
              ...
              <div class="row">
                <div class="">
                  ...
                  <div>
                    <p class="npc-text" id="npctalk">What can I help you with? You need a wepon?</p>
                  </div>
...
const help2_valasz = async () => {
  ...
  NPCCheck(NPCID)
    ...
    szoveg.innerText = 'Maybe your god is not that bad, my wepons will be sharper with this blessing!';
