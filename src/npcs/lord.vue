    ...
    <div class="row side-menu-all">
      <div class="col-md-8 mt-5">
          ...
          <div class="col-md-10 d-flex flex-column justify-content-center align-items-center">
            <div>
              <img class="npc-talk-img" src="../../images/lord.PNG">
            </div>
            <div class="row d-flex ">
              ...
              <div class="row">
                <div class="">
                  <p class="headline-npc" id="headlineID">Thats my property!</p>
                  <div>
                    <p class="npc-text" id="npctalk">What do you want, useless peasant?</p>
                  </div>
...
const help1_valasz = async () => {
  ...
  NPCCheck(NPCID)
    ...
    szoveg.innerText = 'With this new god I can be even richer. I will follow it until the end!';

    szovegCIM.innerText = 'You were usefull once I must admit.';
    szoveg.innerText = 'Maybe you are not bad, my profit will be amazing!';
...
const help2_valasz = async () => {
  ...
  NPCCheck(NPCID)
    ...
    szoveg.innerText = 'Maybe your god is not that bad, my harvest will be rich I can feel it!';
