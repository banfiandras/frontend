    ...
    <div class="row side-menu-all">
      <div class="col-md-8 mt-5">
          ...
          <div class="col-md-10 d-flex flex-column justify-content-center align-items-center">
            <div>
              <img class="npc-talk-img" src="../../images/soldier.PNG">
            </div>
            <div class="row d-flex ">
              ...
              <div class="row">
                <div class="">
                  <p class="headline-npc" id="headlineID">What are you searching for you wimp?
                  </p>
                  <div>
                    <p class="npc-text" id="npctalk">This place is not for a prophet!</p>
                  </div>
...
const help1_valasz = async () => {
  ...
  NPCCheck(NPCID)
    ...
    szoveg.innerText = 'This god can defend me in the heatest battle! I am invincible with his help!';

    szovegCIM.innerText = 'Thank you for the help!';
    szoveg.innerText = 'It seems like you are not a wimp after all. I was wrong!';
...
const help2_valasz = async () => {
  ...
  NPCCheck(NPCID)
    ...
    szoveg.innerText = 'If your god listens to a pray like this, he sure will listen to mine!';
