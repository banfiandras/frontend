    ...
    <div class="row side-menu-all">
      <div class="col-md-8 mt-5">
          ...
          <div class="col-md-10 d-flex flex-column justify-content-center align-items-center">
            <div>
              <img class="npc-talk-img" src="../../images/wanderer.PNG">
            </div>
            <div class="row d-flex ">
              ...
              <div class="row">
                <div class="">
                  <p class="headline-npc" id="headlineID">So you are not afraid of a freak like me?
                  </p>
                  <div>
                    <p class="npc-text" id="npctalk">Nice to meet a human, who's not scared from a cursed man like myself!'</p>
                  </div>
...
const help1_valasz = async () => {
  ...
  NPCCheck(NPCID)
    szovegCIM.innerText = 'I believe this god can help me turn bach to human!';
    szoveg.innerText = 'With this god I can finally be a fear5less worrior again and not just a curesed bear like now!';

    szovegCIM.innerText = 'Thank you for this bath!';
    szoveg.innerText = 'You dont even know how hard to be clean as a bear. Every time I ask for a bath they run away.';
...
const help2_valasz = async () => {
  ...
  NPCCheck(NPCID)
    ...
    szoveg.innerText = 'Do you think if I pray enough I can turn back to my real form?';
