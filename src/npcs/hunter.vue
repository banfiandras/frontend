    ...
    <div class="row side-menu-all">
      <div class="col-md-8 mt-5">
          ...
          <div class="col-md-10 d-flex flex-column justify-content-center align-items-center">
            <div>
              <img class="npc-talk-img" src="../../images/hunter.PNG">
            </div>
            <div class="row d-flex ">
              ...
              <div class="row">
                <div class="">
                  <p class="headline-npc" id="headlineID">You scared my pray!
                  </p>
                  <div>
                    <p class="npc-text" id="npctalk">Say something good or you will be my pray instead of the one you chased away!</p>
                  </div>
...
const help1_valasz = async () => {
  ...
  NPCCheck(NPCID)
    szovegCIM.innerText = 'Maybe if I belive in this god I never be hungry again!';
    szoveg.innerText = 'I hope he can give me my favorite prayes!';

    szovegCIM.innerText = 'You did a good job!';
    szoveg.innerText = 'I forgive you, but never mess with my hunt again!';
...
const help2_valasz = async () => {
  ...
  NPCCheck(NPCID)
    ...
    szoveg.innerText = 'Maybe I can pray for good hunts and even greater game!';
