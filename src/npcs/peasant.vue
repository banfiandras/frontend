    ...
    <div class="row side-menu-all">
      <div class="col-md-8 mt-5">
          ...
          <div class="col-md-10 d-flex flex-column justify-content-center align-items-center">
            <div>
              <img class="npc-talk-img" src="../../images/peasant.PNG">
            </div>
            <div class="row d-flex ">
              ...
              <div class="row">
                <div class="">
                  <p class="headline-npc" id="headlineID">Why can I welcome you here in the rough field?</p>
                  <div>
                    <p class="npc-text" id="npctalk">Can you help me with my hard work, I am old as you can see.</p>
                  </div>
...
const help1_valasz = async () => {
  ...
  NPCCheck(NPCID)
    ...
    szoveg.innerText = 'With this new god I can eat every day, my work is so much easier. I have hope!';

    szovegCIM.innerText = 'Your help saved my life today!';
    szoveg.innerText = 'I can finish the rest alone. Your god must be strong if you are this helpfull.';
...
const help2_valasz = async () => {
  ...
  NPCCheck(NPCID)
    ...
    szoveg.innerText = 'Your god must be great. I will follow your path and belive in a better day with him!';
